...
bool Database::init_tables() {
    ...
    const char* create_favorites = R"(
        CREATE TABLE IF NOT EXISTS favorites (
            ...
            media_url VARCHAR(512) DEFAULT '',
            created_at BIGINT NOT NULL,
            UNIQUE KEY uk_user_message (user_id, message_id, message_type),
            INDEX idx_created_at (created_at),
            FOREIGN KEY (user_id) REFERENCES users(user_id) ON DELETE CASCADE
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
    )";
    ...
    if (mysql_query(connection_, create_favorites) != 0) {
        std::cerr << "Failed to create favorites table: " << mysql_error(connection_) << std::endl;
        return false;
    }
    std::cerr << "Created favorites table" << std::endl;
                ...
                << "WHERE message_id = " << message_id;
                    ...
                    std::string Database::get_fcm_token(uint64_t user_id) {
                        ...
                        return "";
                                        ...
                                        bool Database::add_favorite(uint64_t user_id, uint64_t message_id, 
                                            ...
                                            if (!ensure_connection()) {
                                                ...
                                                std::cerr << "Database connection failed in add_favorite" << std::endl;
                                            ...
                                            std::string escaped_media_url = escape_string(media_url);
                                            ...
                                            std::string escaped_type = escape_string(message_type);
                                            ...
                                            sql << "INSERT INTO favorites (user_id, message_id, message_type, sender_id, "
                                                ...
                                                << "content, media_type, media_url, created_at) VALUES ("
                                                ...
                                                << user_id << ", " << message_id << ", '" << escaped_type << "', "
                                                ...
                                                << static_cast<int>(media_type) << ", '" << escaped_media_url << "', "
                                                ...
                                                << "ON DUPLICATE KEY UPDATE content = '" << escaped_content << "'";
                                            ...
                                            if (mysql_query(connection_, sql.str().c_str()) != 0) {
                                                ...
                                                std::cerr << "MySQL query failed in add_favorite: " << mysql_error(connection_) << std::endl;
                                        ...
                                        bool Database::remove_favorite(uint64_t user_id, uint64_t message_id, 
                                        ...
                                        bool Database::get_favorites(uint64_t user_id, int limit, int offset, 
                                            ...
                                            if (!ensure_connection()) {
                                                ...
                                                std::cerr << "Database connection failed in get_favorites" << std::endl;
                                            ...
                                            sql << "SELECT f.message_id, f.message_type, f.sender_id, f.content, "
                                                ...
                                                << "f.media_type, f.media_url, f.created_at, "
                                            ...
                                            if (mysql_query(connection_, sql.str().c_str()) != 0) {
                                                ...
                                                std::cerr << "MySQL query failed in get_favorites: " << mysql_error(connection_) << std::endl;
                                            ...
                                            while ((row = mysql_fetch_row(result))) {
                                                ...
                                                fav["message_id"] = std::stoull(row[0]);
                                                ...
                                                fav["sender_id"] = std::stoull(row[2]);
                                                ...
                                                fav["media_type"] = row[4] ? std::stoi(row[4]) : 0;
                                                ...
                                                fav["created_at"] = std::stoll(row[6]);
                                                ...
                                                fav["sender_username"] = row[7] ? row[7] : "";
                                                ...
                                                fav["sender_nickname"] = row[8] ? row[8] : "";
                                        ...
                                        bool Database::is_favorited(uint64_t user_id, uint64_t message_id, 
                                            ...
                                            bool is_fav = row && std::stoi(row[0]) > 0;
